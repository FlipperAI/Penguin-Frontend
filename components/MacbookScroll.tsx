...
export const Lid = ({
  ...
  src?: string;
    ...
    const videoSrc = "https://cdn.pixabay.com/video/2020/02/24/32767-394004551_large.mp4";
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <video 
                  src={"https://cdn.dribbble.com/userupload/7314909/file/original-e54e32fefb908ac7ff18ded0efb97695.mp4"} 
                  alt="TuxCode app video" 
                  width={1248} 
                  height={765} 
                  autoPlay
                  muted
                  loop
                  playsInline
                  // No controls attribute, so no controls will appear
                />
      </motion.div>
    </div>
  );
